package _Vehicle_management.view;
import _Vehicle_management.Util.ConstantUtil;
...
import _Vehicle_management.service.*;
...
public class MainMenu {
    ...
    private static void display() {
        ...
        switch (choice) {
            ...
            case 3 : {
                List<Moto> motors = motorService.findAll();
    ...
    private static void delete() {
        ...
        if (truckService.findByID(vehicleID)) {
            deleteWithConfirm(truckService, vehicleID);
        } else if (carService.findByID(vehicleID)) {
            deleteWithConfirm(carService, vehicleID);
        } else if (motorService.findByID(vehicleID)) {
            deleteWithConfirm(motorService, vehicleID);
        } else {
    ...
    private static void search() {
        ...
        List<Moto> motors = motorService.search(driverPlate);
    ...
    private static void add() {
        ...
        switch (choice) {
            ...
            case 3 : {
                ...
                Moto motor = new Moto(plate, manufacturer, yearOfManufacturer, owner, wattage);
